...
const fetchAndDisplayWeatherData = ()=>{
    ...
    //let city = ids[inputElement.value];
...
const renderData = (data)=>{
    ...
    const {city,country,currentDesc,currentTemp,currentWind,currentPressure,forecasts} = data
    ...
    <div class="curent-weather">
        ...
        <img src = "./assets/weather/${data.currentDesc}.svg"/>
        ${data.currentDesc}
        </div>
        <div class="curent-temp">${data.currentTemp}°c</div>
        <div class="curent-other">
            <div class="wind">Wind: ${data.currentWind}</div>
            <div class="presure">Pressure: ${data.currentPressure}</div>
        </div>
   </div>
